    ...
    <div className="min-h-screen flex bg-gray-50">
      ...
      <aside className="hidden md:flex md:flex-col w-64 bg-white border-r border-gray-100 fixed h-full">
        <div className="px-6 py-5 border-b border-gray-100">
          ...
          <p className="text-xs text-gray-500 mt-0.5">{user?.role === 'admin' ? 'Admin Panel' : 'Client Portal'}</p>
        </div>
      ...
      {/* Main content */}
      <main className="flex-1 md:ml-64 pt-16 md:pt-6 pb-20 md:pb-6 px-4 md:px-8">
